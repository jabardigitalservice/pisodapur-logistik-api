...
class VaccineRequestResource extends JsonResource
{
  ...
  public function toArray($request)
  {
      return [
        ...
        'agency_address' => $this->agency_location_address,
        'agency_village_id' => $this->agency_location_village_code,
        'agency_village_name' => $this->village->kemendagri_desa_nama,
        'agency_district_id' => $this->agency_location_subdistrict_code,
        'agency_district_name' => $this->village->kemendagri_kecamatan_nama,
        'agency_city_id' => $this->agency_location_district_code,
